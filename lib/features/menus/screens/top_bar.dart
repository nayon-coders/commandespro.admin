...
class TopbarWidgets extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: isMobile || isTab ? EdgeInsets.all(10) : EdgeInsets.all(AppPadding.defaultPadding),
      ...
      child: Row(
        ...
        children: [
          Image.asset("assets/images/logo.png", width: isMobile || isTab ? 160 : 200, height: 100,),
          Row(
            children: [
              IconButton(
                onPressed: () {},
