...
class _AddProductsState extends State<AddProducts> {
  ...
  Widget build(BuildContext context) {
    return AppScaffold(
      body: Container(
        width: Get.width,
        padding: EdgeInsets.only(left: 100, right: 100, top: 40, bottom: 50),
        child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 20,),
                            Expanded(child: AppInput(text: "VAT(%)", hint: "0.00", controller: controller.productTex.value)),
                          ],
                        ),
                        SizedBox(height: 20,),
                        Text("Product Image",
                ...
                return InkWell(
                  onTap: ()async{
                    if(   controller.isEdit.value  ){
                      await controller.updateProduct(images, controller.selectedSingleProductListModel.value.id.toString());
                    }else{
