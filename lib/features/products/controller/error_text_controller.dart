...
class AddProductErrorText{
  ...
  static bool get isError{
    if(productNameError.value.isNotEmpty || productPriceError.value.isNotEmpty || productDescriptionError.value.isNotEmpty || productShortDescriptionError.value.isNotEmpty || productCategoryError.value.isNotEmpty || productUnitError.value.isNotEmpty || productUnitListError.value.isNotEmpty || productStockError.value.isNotEmpty || productOriginError.value.isNotEmpty || productVatError.value.isNotEmpty ||  productSubCategoryError.value.isNotEmpty){
      return true;
    }
    return false;
  }
